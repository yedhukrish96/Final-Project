...
def main():
    ...
    if ( choice == 'Home' ):
        st.title("Welcome to the Loan Prediction App!!")
        st.image('Desktop/dokumenty/Kiva.jpeg')
        st.write("This app uses a KNN model to predict whether your loan application will be approved or rejected based on the details you provide.")
        pass
